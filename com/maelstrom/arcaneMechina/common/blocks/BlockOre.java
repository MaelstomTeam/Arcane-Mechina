...
public class BlockOre extends Block {
    ...
    public int quantityDropped(Random r){
        return this == ModBlocks.gemOre ? 1 : 1;
    }
    ...
    {
    	if(this == ModBlocks.gemOre)
    		return null;//InitItem.gem;
    	else if (this == ModBlocks.metalOre)
    		return Item.getItemFromBlock(this);
    	else return Item.getItemFromBlock(Blocks.stone);
    }
}
