...
import com.maelstrom.snowcone.modelloader.obj.ObjModelLoader;
import com.maelstrom.snowcone.modelloader.techne.TechneModelLoader;
 ...
 * method. Instances can be created by calling {loadModel(String)} with a
 * class-loadable-path
 * 
 * @author cpw
 * 
