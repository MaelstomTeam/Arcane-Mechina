...
public class RuneWorldCraftingGui extends ContainerScreen<RuneDrawingContainer> implements IHasContainer<RuneDrawingContainer>
{
	public RuneWorldCraftingGui(RuneDrawingContainer con, PlayerInventory inv, ITextComponent title)
	{
