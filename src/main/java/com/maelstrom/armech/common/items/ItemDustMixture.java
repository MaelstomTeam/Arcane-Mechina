...
public class ItemDustMixture extends Item {
	public ItemDustMixture()
	{
		super();
	...
	public void addInformation(ItemStack itemstack, EntityPlayer player, List subtext, boolean bool)
	{
		if(itemstack.getItemDamage() >= 6)
			subtext.add(StatCollector.translateToLocal("dust_type."+Reference.dustNames[itemstack.getItemDamage()]));
		else
			subtext.add(StatCollector.translateToLocal("dust_type."+Reference.dustNames[itemstack.getItemDamage()]));
	}
	...
	public int getColorFromItemStack(ItemStack stack, int renderPass)
	{
		...
		}catch(Exception e){return Color.WHITE.hashCode();}
	}
